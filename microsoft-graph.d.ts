...
export type SubjectAlternativeNameType = "none" | "emailAddress" | "userPrincipalName" | "customAzureADAttribute"
...
export type AppleVpnConnectionType = "ciscoAnyConnect" | "pulseSecure" | "f5EdgeClient" | "dellSonicWallMobileConnect" | "checkPointCapsuleVpn" | "customVpn" | "ciscoIPSec" | "citrix" | "ciscoAnyConnectV2" | "paloAltoGlobalProtect"
...
export type TeamsAppInstalledState = "notInstalled" | "installed" | "installedAndHidden" | "installedAndPermanent"
export type TeamsAppContext = "teamsOwned" | "tenantOwned" | "sideloaded"
...
export type ApplicationPermissionRequired = "unknown" | "anonymous" | "guest" | "user" | "administrator" | "system" | "unknownFutureValue"
export type AlertStatus = "unknown" | "newAlert" | "inProgress" | "resolved" | "unknownFutureValue"
export type AlertType = "unknown" | "singleSensorAtomic" | "singleSensorCompound" | "multiSensorCompound" | "unknownFutureValue"
...
export type SecurityNetworkProtocol = "unknown" | "ip" | "icmp" | "igmp" | "ggp" | "ipv4" | "tcp" | "pup" | "udp" | "idp" | "ipv6" | "ipv6RoutingHeader" | "ipv6FragmentHeader" | "ipSecEncapsulatingSecurityPayload" | "ipSecAuthenticationHeader" | "icmpV6" | "ipv6NoNextHeader" | "ipv6DestinationOptions" | "nd" | "raw" | "ipx" | "spx" | "spxII" | "unknownFutureValue"
...
export interface Application extends DirectoryObject {
	    ...
	    /** Specifies if the application can act as a public client. For example,  an installed application running on a mobile device. Default value is false. */
		        allowPublicClient?: boolean
	
	    /** The URIs that identify the application. For more information see, Application Objects and Service Principal Objects. The any operator is required for filter expressions on multi-valued properties. Not nullable. */
...
export interface AndroidForWorkMobileAppConfiguration extends ManagedDeviceMobileAppConfiguration {
	    ...
	    /** Android For Work app configuration package name. */
		        packageName?: string
...
export interface TeamsApp extends Entity {
		        ...
		        installedState: TeamsAppInstalledState
	
		        context: TeamsAppContext
...
export interface Security extends Entity {
		        ...
		        applicationSecurityProfiles?: ApplicationSecurityProfile[]
...
export interface Alert extends Entity {
	    ...
	    /** Threat intelligence activity group(s) that this alert is attributed to. */
		        activityGroupStates?: ActivityGroupState[]
	
	    /** Security-related stateful information generated by the provider about the application(s) related to this alert. */
		        applicationStates?: ApplicationSecurityState[]
	    ...
	    /** Provider generated/calculated risk score of the alert. */
		        riskScore?: string
	    ...
	    /** If the alert was triggered by one or more sensors and one or more detections.  Possible values are: unknown, singleSensorAtomic, singleSensorCompound, multiSensorCompound. */
		        type: AlertType
...
export interface ApplicationSecurityProfile extends Entity {
...
export interface Api {
	    ...
	    /** Specifies the accepted access token version for the current API resource. Possible values are 1 or 2. */
...
export interface ActivityGroupState {
	    ...
	    /** STIX 2.0 standard list of aliases for the activity group. */
		        aliases?: string[]
	
	    /** STIX 2.0 standard display name for the activity group. */
		        name?: string
	
}
export interface ApplicationSecurityState {

	    /** URI to deployment package and/or type of deployment package. (for example, appx, MSI, and so on). */
		        deploymentPackageUrl?: string
	
	    /** Application name. */
		        name?: string
	
	    /** The level of permissions the application requires to function. Possible values are: unknown, anonymous, guest, user, administrator, system. */
		        permissionsRequired?: ApplicationPermissionsRequired
	
	    /** The application publisher name. This helps distinguish between applications with the same AppX name. */
		        publisher?: string
	
	    /** Provider-generated/calculated risk score of the application. */
		        riskScore?: string
	
}
export interface FileSecurityState {

	    /** Authenticode 256 hash of image file (used by AppLocker and others). */
		        authenticodeHash256?: string
	    ...
	    /** Sha256 cryptographic hash of the alert file. */
		        sha256?: string
...
export interface HostSecurityState {
	    ...
	    /** True if the host is domain joined to Azure Active Directory Domain Services. */
		        isAzureAadJoined?: boolean
	
	    /** True if the host registered with Azure Active Directory Device Regsitration (BYOD devices - that is, not fully managed by enterprise). */
		        isAzureAadRegistered?: boolean
...
export interface MalwareState {
	    ...
	    /** List of aliases for the malware. */
		        aliases?: string[]
...
export interface Process {
	    ...
	    /** Sha256 cryptographic hash of process image file. */
		        sha256?: string
...
export interface VulnerabilityState {
	    ...
	    /** STIX 2.0 standard display name for the vulnerability. */
		        name?: string
